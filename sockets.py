        ...
        while True:
            ...
            if (msg is not None):
                ...
                if ("WS onopen" not in packet):
                    ...
                    for key in current_world:
                        ws.send(json.dumps({key: current_world[key]}))
...
def get_entity(entity):
    ...
    return_entity = myWorld.get(entity)
    myWorld.clear()
    return flask.jsonify(return_entity), 200
